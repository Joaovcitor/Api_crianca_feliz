...
router.post("/agendar-visita/:id", authenticateJWT, VisitasController.agendaVisita);
router.get("/visitas-marcadas/:id", authenticateJWT, VisitasController.ShowVisitasMarcadas)
